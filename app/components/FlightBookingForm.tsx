    ...
    <div className="min-h-[70vh] p-6">
      <div className="max-w-7xl mx-auto">
        <div className="bg-card rounded-t-2xl shadow-lg border border-border">
          <div
            className="flex w-full h-full border-b border-gray-200 
  bg-gradient-to-r from-[#5A0F1A] to-[#7B1E3D] 
  text-white rounded-t-2xl overflow-hidden shadow-md"
          >
            <button
              className="w-1/4 flex items-center justify-center gap-2 py-5 
            ...
            : "border-gray-400"
                ...
                <span
                  className={`font-medium transition-colors ${
                    tripType === "return" ? "text-[#5A0F1A]" : "text-gray-800"
                  }`}
                >
                  Return
                </span>
        ...
        ${
          tripType === "oneway"
            ...
            : "border-gray-400"
                ...
                <span
                  className={`font-medium transition-colors ${
                    tripType === "oneway" ? "text-[#5A0F1A]" : "text-gray-800"
                  }`}
                >
                  One Way
                </span>
          ...
          tripType === "multicity"
            ...
            <div className="flex flex-wrap items-end gap-3 mb-8 bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="flex items-center justify-center pb-2">
                <button className="p-3 rounded-full bg-gradient-to-r from-[#5A0F1A] to-[#7B1E3D] hover:from-[#4A0C15] hover:to-[#681A33] text-white shadow-md hover:scale-105 transition-transform">
              ...
              <div className="flex-1 min-w-[160px]">
                ...
                <input
                  ...
                  className={`w-full h-14 px-4 text-base border rounded-xl bg-white shadow-sm 
